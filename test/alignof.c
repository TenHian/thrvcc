...
int main()
{
	// [117] support for '_Alignof' and '_Alignas'
	printf("[117] support for '_Alignof' and '_Alignas'\n");
	...
	// [118] support '_Alignof' for variable
	printf("[118] support '_Alignof' for variable\n");
	ASSERT(1, ({
		       char x;
		       _Alignof(x);
	       }));
