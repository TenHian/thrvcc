...
int main()
{
	...
	printf("[10] Support single-letter var\n");
	ASSERT(3, ({
		       int a;
		       a = 3;
		       a;
	...
	// [11] Support multi-letter var
	printf("[11] Support multi-letter var\n");
	ASSERT(3, ({
		       int a = 3;
		       a;
	       }));
	...
	// [44] Support for code block scopes
	printf("[44] Support for code block scopes\n");
	ASSERT(2, ({
		       int x = 2;
		       {
			       int x = 3;
	...
	// [58] Support for nested type declarators
	printf("[58] Support for nested type declarators\n");
	ASSERT(24, ({
		       char *x[3];
		       sizeof(x);
	       }));
