...
assert() {
  ...
  echo "$input" | ./thrvcc -o tmp.s - || exit
...
# [27] Support for multi-dimensional arrays
echo [27]
...
# [32] Support for string literals
echo [32]
assert 0 'int main() { return ""[0]; }'
...
# [33] Support for escaped characters
echo [33]
...
# [34] Support for octal escape characters
echo [34]
...
# [35] Support for hexadecimal escape characters
echo [35]
...
# [36] Support for statement expression, GNU feature
echo [36]
assert 0 'int main() { return ({ 0; }); }'
